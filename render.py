"""SAGS Rendering Script.

Renders trained models and optionally reconstructs 3D point clouds.
"""
...
from arguments.__init__ import ModelParams, PipelineParams, get_combined_args, ModelHiddenParams
...
def reconstruct_point_cloud(images, masks, depths, camera_parameters, name):
    ...
    for i_frame in frames:
        ...
        print("Rendering point clouds finish!")

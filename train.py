"""SAGS Training Script.

Two-stage training: coarse (static Gaussians) -> fine (deformable Gaussians).
"""
...
from arguments.__init__ import ModelParams, PipelineParams, OptimizationParams, ModelHiddenParams
    ...
    for iteration in range(first_iter, final_iter + 1):
        ...
        with torch.no_grad():
            ...
            if iteration < opt.densify_until_iter:
                ...
                if iteration > opt.densify_from_iter and iteration % (opt.densification_interval * 3) == 0:
